...
# sudo pacman -Syyy
# sudo pacman -S neovim python3 python3-pip python3-venv git curl exuberant-ctags -y

# # Install Node.js v16.x (for Ubuntu) for coc.vim
# curl -fsSL https://deb.nodesource.com/setup_16.x | sudo -E bash -
# sudo pacman -S -y nodejs

# # Install The Silver Searcher (ag), ripgrep (rg) and bat for fzf.vim
# sudo pacman -S -y silversearcher-ag
# sudo pacman -S -y -o Dpkg::Options::="--force-overwrite" bat ripgrep # https://github.com/sharkdp/bat/issues/938
